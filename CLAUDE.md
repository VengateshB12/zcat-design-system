...
- Popup close is in the FOOTER, not the header — the zcat Popup has NO X close button in the header. Cancel/Close is a Ghost button in the footer next to the primary action. NEVER add a manual X close icon in the popup header
