...
| Me- Drawer Sample | `13420:10799` | Side drawer / AI assistant | Drawer shell proportions and placement. **Rough sample, not pixel-accurate — take the structure, not the spacing.** A zcat drawer sits on `Popup Blur` and closes from an **X in its header** (unlike Popup, which closes from its footer) |
